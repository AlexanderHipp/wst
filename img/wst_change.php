    ...
    <div id="main">
		...
		<?php
			...
			if (isset($_POST['query_meg_codes'])) {
				...
				if (($bezeichnung == "") OR ($bezeichnung_en == "") OR ($geheim == "") OR ($regal == "") OR ($reihe == "") OR ($fach == "") OR ($menge == "") OR ($rohteil == "") OR ($kunde == "") OR ($branche == "") OR ($technologie_1 == "") OR ($technologie_2 == "") OR ($technologie_3 == "") OR ($baureihe == "") OR ($maschtyp == "") OR ($maschnr == "") OR ($stueckzeit == "") OR ($programmierer == "") OR ($werkstoff == "") OR ($foto == "")) { $feedback = 1; } else {		
        ...
        <div id="box" style="clear:both;">
         ...
         <div id="box">
        	...
        	<div id="box">
                ...
                <label <?php if ($fb_bild == 1) { echo 'class="red_fb"'; } ?> for="Bild">Bild </label>
                <input type="file" id="foto" name="foto" style="margin-left:90px;"/><?php echo $zeile['foto']; ?></input>
            </div>
