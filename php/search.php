                  		...
                  		<tr>
                            ...
                            <td>
                                ...
                                <?php 
									// Administrator
									if($_SESSION['rolle'] != "4") {
										?> <input style="margin-left:12px;" id="ja" name="suche_geheim" type="radio" value="1" 	<?php if( $_GET['suche_geheim'] == 1) { echo "checked='checked'"; } ?> /> <?php if ($la == en) {echo 'confidental';} else {echo 'geheim';} ?><?php
									} 
								?>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td style="padding-left:10px;" colspan="3">
									...
									<?php if( $baureihe[6] == 406 ) {echo "meg_btn_pushed";} ?>
