                     ...
                     <div id="box_2_col">
                      ...
                      <div id="box_2_col">
                        <table border="0">
                            ...
                            <tr>
                                <td><label <?php if ($fb_wkunden == 1) { echo 'class="red_fb"'; } ?> for="wkunden">weitere Kunden </label></td>
                                <td><input  id="wkunden" name="wkunden" class="element text small" type="text" size="15" maxlength="255" value="<?php echo $wkunden; ?>"/></td>
                            </tr> 
                            <tr>
