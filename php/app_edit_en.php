...
<div id="page">
    ...
    <?php
		...
		if (isset($_POST['submit'])) {
			...
			if (($besonderheiten_en == "") OR ($kundennutzen_en == "") OR ($prodv == "") OR ($quali_en == "") OR ($fert_en == "")) { $feedback = 1; } else {
                      ...
                      <div id="box_2_col" style="min-height:257px;" >
                       ...
                       <div id="box_2_col" style="min-height:360px;">
                        <table border="0">
                            ...
                            <tr>
                                <td><label <?php if ($fb_prodv == 1) { echo 'class="red_fb"'; } ?> for="prodv">Production volume </label></td>
