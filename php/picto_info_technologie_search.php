...
*/
	...
	if ($zeile_wst['technologie_1'] == 102) {
		echo '<img src="../img/picto/meg_102.png" width="32" height="32" style="margin-left:5px;margin-bottom:5px;"/>';
	}
	if ($zeile_wst['technologie_1'] == 103) {
		echo '<img src="../img/picto/meg_103.png" width="32" height="32" style="margin-left:5px;margin-bottom:5px;"/>';
	}
	...
	if ($zeile_wst['technologie_3'] == 122) {
		echo '<img src="../img/picto/meg_122.png" width="32" height="32" />';
	}
	if ($zeile_wst['technologie_3'] == 123) {
		echo '<img src="../img/picto/meg_123.png" width="32" height="32" />';
	}
