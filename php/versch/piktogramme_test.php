                            	    ...
                            	    <div class="meg_group" id="MEG_GROUP_MEG04">
                                    	<div class="meg_subgroup" id="MEG_SUBGROUP_MEG04_">
                                            ...
                                            <div id="meg404" class="meg_btn" onClick="$('#meg404').toggleClass('meg_btn_pushed')" style="background-image:url(../img/meg_404_4multistate.png)" title="18"></div>
																						<div id="meg407" class="meg_btn" onClick="$('#meg407').toggleClass('meg_btn_pushed')" style="background-image:url(../img/meg_407_4multistate.png)" title="24"></div>
																						<div id="meg408" class="meg_btn" onClick="$('#meg408').toggleClass('meg_btn_pushed')" style="background-image:url(../img/meg_408_4multistate.png)" title="26"></div>
