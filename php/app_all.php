                    ...
                    <?php
                        echo '<table border ="0">';
                            ...
                            while ($zeile_app = mysqli_fetch_array($ergebnis_app)) {
                                ...
                                $ergebnis_user = mysqli_query($db, $sql_user) or die('');
                                ...
                                if ($zeile_wst['de'] != 6) {
									...
									if ($zuweisung_en)
									{
										...
										$ergebnis_user_en = mysqli_query($db, $sql_user_en) or die('Es konnten keine Informationen über die User abgerufen werden. Bitte versuchen Sie es noch einmal.');
